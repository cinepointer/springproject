    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())  // CSRF 비활성화
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/", "/loginForm", "/signin", "/signup", "/css/**", "/js/**", "/images/**").permitAll() // 공개 URL
            ...
            .formLogin(form -> form
                ...
                .defaultSuccessUrl("/movies", true)  // 로그인 성공 후 이동 URL
                .permitAll()  // 모든 사용자에게 로그인 페이지 허용
            )
            .logout(logout -> logout
                .logoutUrl("/logout")  // 로그아웃 URL
                .logoutSuccessUrl("/signin")  // 로그아웃 성공 후 이동 URL
...
//    }
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder
            ...
            .authoritiesByUsernameQuery("select user_id,user_enabled from users where user_id=?")
